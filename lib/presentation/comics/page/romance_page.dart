          ...
          children: [
            ...
            Center(
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                  "we have a collection of romantic comics for all the hopeless romantics out there. Enjoy the journey to the world of love from here",
                  style: TextStyle(
                    fontFamily: 'MontserratMedium',
                    color: Colors.black,
                    fontSize: 15
