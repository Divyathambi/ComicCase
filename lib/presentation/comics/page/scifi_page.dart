        ...
        body: ListView(
          children: [
            Hero(
              ...
              child: FadeInImage(
                fit: BoxFit.cover,
                image: AssetImage('assets/images/sci-fi.jpg'), 
            ...
            Center(
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                  "What if the world is full of fictionary characters and stories? Don't look anymore! You're in the right place. Our Sci-fi comics can make you enter into unknown worlds.",
                  style: TextStyle(
                    fontFamily: 'MontserratMedium',
                    color: Colors.black,
                    fontSize: 15
