        ...
        body: ListView(
          children: [
            Hero(
              ...
              child: FadeInImage(
                fit: BoxFit.cover,
                image: AssetImage('assets/images/thriller.jpg'), 
            ...
            Center(
              child: Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text(
                  "As the name implies this section is filled with comics that can make your eyes go wider and leave your mind in need for more. Dive into the world of thrilling and bone chilling stories.",
                  style: TextStyle(
                    fontFamily: 'MontserratMedium',
                    color: Colors.black,
                    fontSize: 15
